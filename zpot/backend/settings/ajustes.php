...
<head>
   ...
   .modal {
    ...
    .toggle-password:hover {
        color: var(--brand-dark);
        opacity: 1;
        background: rgba(207, 204, 196, 0.15);
    }
    ...
    .toggle-password:focus {
        ...
        color: var(--brand-dark);
        opacity: 1;
        box-shadow: 0 0 0 2px rgba(244, 221, 73, 0.3);
    }
    ...
    .modal-content .password-wrapper input {
        margin-bottom: 0;
    }
    </style>
</head>
                        ...
                        <div id="passwordBox" class="ajuste-content">
                            <form id="formPassword">
                                <div class="password-wrapper">
                                    ...
                                    <button type="button" class="toggle-password" aria-label="Mostrar contraseña" onclick="togglePasswordVisibility('currentPass', this)">
                                ...
                                <div class="password-wrapper">
                                    ...
                                    <button type="button" class="toggle-password" aria-label="Mostrar contraseña" onclick="togglePasswordVisibility('newPass', this)">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="eye-icon">
                                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                            <circle cx="12" cy="12" r="3"></circle>
                                        </svg>
                                ...
                                <div class="password-wrapper">
                                    ...
                                    <button type="button" class="toggle-password" aria-label="Mostrar contraseña" onclick="togglePasswordVisibility('confirmPass', this)">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="eye-icon">
                                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                            <circle cx="12" cy="12" r="3"></circle>
                                        </svg>
    ...
    <div id="deleteModal" class="modal">
        <div class="modal-content">
            ...
            <div class="password-wrapper">
                ...
                <button type="button" class="toggle-password" aria-label="Mostrar contraseña" onclick="togglePasswordVisibility('deletePass', this)">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="eye-icon">
                        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                        <circle cx="12" cy="12" r="3"></circle>
                    </svg>
